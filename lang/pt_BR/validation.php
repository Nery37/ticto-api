...
return [
    ...
    */
    ...
    'document_number' => 'Documento inválido',
    'full_name' => 'Você precisa informar o nome completo.',
    ...
    */
    ...
    'zipcode' => 'campo :attribute é obrigatório',
    ...
    */
    ...
    'attributes' => [
        ...
        'percent' => 'percentual da garantia',
        ...
        '*.taker_name' => 'Tomador',
        '*.taker_document' => 'CPF/CNPJ do tomador',
        '*.insured_name' => 'Benefíciário',
        '*.insured_document' => 'CPF/CNPJ do beneficiário',
        '*.start_date' => 'Início',
        '*.end_date' => 'Término',
        '*.external_identifier' => 'Valor do Boleto',
    ],
];
